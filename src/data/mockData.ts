...
export const mockCustomers: Customer[] = [
  { id: 'C001', businessId: 'demo', userId: '', customerCode: 'CUST-1001', fullName: 'Rahul Sharma', phone: '+91 98765 43210', email: 'rahul@email.com', address: '42, Lake View Apartments', area: 'Koramangala', status: 'active', subscriptionStatus: 'active', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2026-01-15', updatedAt: '2026-01-15' },
  { id: 'C002', businessId: 'demo', userId: '', customerCode: 'CUST-1002', fullName: 'Priya Patel', phone: '+91 87654 32109', email: 'priya@email.com', address: '15, Green Park Colony', area: 'Indiranagar', status: 'active', subscriptionStatus: 'active', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2026-02-20', updatedAt: '2026-02-20' },
  { id: 'C003', businessId: 'demo', userId: '', customerCode: 'CUST-1003', fullName: 'Amit Singh', phone: '+91 76543 21098', email: 'amit@email.com', address: '8, Sunshine Apartments', area: 'Whitefield', status: 'paused', subscriptionStatus: 'none', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2026-03-10', updatedAt: '2026-03-10' },
  { id: 'C004', businessId: 'demo', userId: '', customerCode: 'CUST-1004', fullName: 'Sneha Gupta', phone: '+91 65432 10987', email: 'sneha@email.com', address: '23, River View Complex', area: 'JP Nagar', status: 'active', subscriptionStatus: 'active', paymentStatus: 'pending', walletBalance: 0, weekendServiceRequired: true, createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  { id: 'C005', businessId: 'demo', userId: '', customerCode: 'CUST-1005', fullName: 'Vikram Joshi', phone: '+91 54321 09876', email: 'vikram@email.com', address: '56, MG Road', area: 'MG Road', status: 'active', subscriptionStatus: 'active', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2025-12-01', updatedAt: '2025-12-01' },
  { id: 'C006', businessId: 'demo', userId: '', customerCode: 'CUST-1006', fullName: 'Deepak Kumar', phone: '+91 43210 98765', email: 'deepak@email.com', address: '12, Patel Nagar', area: 'BTM Layout', status: 'active', subscriptionStatus: 'active', paymentStatus: 'overdue', walletBalance: 0, weekendServiceRequired: false, createdAt: '2026-01-28', updatedAt: '2026-01-28' },
  { id: 'C007', businessId: 'demo', userId: '', customerCode: 'CUST-1007', fullName: 'Ananya Reddy', phone: '+91 32109 87654', email: 'ananya@email.com', address: '34, Hitech City', area: 'HSR Layout', status: 'active', subscriptionStatus: 'active', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2026-02-14', updatedAt: '2026-02-14' },
  { id: 'C008', businessId: 'demo', userId: '', customerCode: 'CUST-1008', fullName: 'Ravi Verma', phone: '+91 21098 76543', email: 'ravi@email.com', address: '7, Gandhi Nagar', area: 'Jayanagar', status: 'inactive', subscriptionStatus: 'none', paymentStatus: 'paid', walletBalance: 0, weekendServiceRequired: false, createdAt: '2025-10-20', updatedAt: '2025-10-20' },
];
...
export const mockWeeklyMenu: WeeklyMenu = {
  ...
  updatedAt: '',
  days: {
    monday: { breakfast: [{ itemId: 'F001', itemName: 'Poha', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F005', itemName: 'Dal Rice', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }, { itemId: 'L-PAPAD', itemName: 'Papad', quantity: 1 }], dinner: [{ itemId: 'F010', itemName: 'Dal Tadka + Rice', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
    tuesday: { breakfast: [{ itemId: 'F002', itemName: 'Paratha with Curd', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F006', itemName: 'Paneer Curry + Chapati', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }], dinner: [{ itemId: 'F011', itemName: 'Mixed Veg + Chapati', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
    wednesday: { breakfast: [{ itemId: 'F003', itemName: 'Upma', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F007', itemName: 'Rajma Chawal', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }], dinner: [{ itemId: 'F012', itemName: 'Kadhi Chawal', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
    thursday: { breakfast: [{ itemId: 'F004', itemName: 'Idli Sambhar', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F008', itemName: 'Veg Biryani', quantity: 1 }, { itemId: 'L-RAITA', itemName: 'Raita', quantity: 1 }], dinner: [{ itemId: 'F005', itemName: 'Dal Rice', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
    friday: { breakfast: [{ itemId: 'F001', itemName: 'Poha', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F009', itemName: 'Chole Bhature', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }], dinner: [{ itemId: 'F006', itemName: 'Paneer Curry + Chapati', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
    saturday: { breakfast: [{ itemId: 'F002', itemName: 'Paratha with Curd', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'F005', itemName: 'Dal Rice', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }, { itemId: 'L-PAPAD', itemName: 'Papad', quantity: 1 }], dinner: [{ itemId: 'F008', itemName: 'Veg Biryani', quantity: 1 }, { itemId: 'L-RAITA', itemName: 'Raita', quantity: 1 }] },
    sunday: { breakfast: [{ itemId: 'F004', itemName: 'Idli Sambhar', quantity: 1 }, { itemId: 'B-TEA', itemName: 'Tea', quantity: 1 }], lunch: [{ itemId: 'SUN-THALI', itemName: 'Special Thali', quantity: 1 }, { itemId: 'SUN-SWEET', itemName: 'Gulab Jamun', quantity: 1 }], dinner: [{ itemId: 'F006', itemName: 'Paneer Curry + Chapati', quantity: 1 }, { itemId: 'F013', itemName: 'Salad', quantity: 1 }] },
  },
};
